...
public class JWTAuthenticationMechanism implements HttpAuthenticationMechanism {
    ...
    public AuthenticationStatus validateRequest(HttpServletRequest req, HttpServletResponse res, HttpMessageContext context){
        ...
        if (credential != null) {
            ...
            //res.setStatus(405);
            if(!req.getRequestURI().contains("login") && !req.getRequestURI().contains("rest") && !req.getRequestURI().contains("apiee") && !req.getRequestURI().contains("swagger" ) && !req.getRequestURI().contains("authentication" )&& !req.getRequestURI().contains("resource" )){
